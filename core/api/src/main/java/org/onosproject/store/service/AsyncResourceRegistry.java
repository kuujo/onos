...
/**
 * Asynchronous service for storing/registering resource and consumer information.
 */
@Beta
public interface AsyncResourceRegistry extends Store<ResourceEvent, ResourceStoreDelegate> {
     ...
     */
    CompletableFuture<Boolean> register(List<? extends Resource> resources);
     ...
     * @return true if the registration succeeds, false otherwise
     */
    CompletableFuture<Boolean> unregister(List<? extends ResourceId> ids);
     ...
     */
    CompletableFuture<Boolean> allocate(List<? extends Resource> resources, ResourceConsumer consumer);
     ...
     */
    CompletableFuture<Boolean> release(List<ResourceAllocation> allocations);
     ...
     */
    CompletableFuture<List<ResourceAllocation>> getResourceAllocations(ResourceId id);
     ...
     */
    CompletableFuture<Boolean> isAvailable(Resource resource);
     ...
     */
    CompletableFuture<Collection<Resource>> getResources(ResourceConsumer consumer);
     ...
     */
    CompletableFuture<Set<Resource>> getChildResources(DiscreteResourceId parent);
     ...
     * the specified class
     */
    <T> CompletableFuture<Set<Resource>> getChildResources(DiscreteResourceId parent, Class<T> cls);
     ...
     * whose type is the specified class.
     */
    <T> CompletableFuture<Collection<Resource>> getAllocatedResources(DiscreteResourceId parent, Class<T> cls);
}
