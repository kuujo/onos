...
/**
 * Service for registering/allocating resource and consumer information.
 */
@Beta
public interface ResourceRegistry extends Store<ResourceEvent, ResourceStoreDelegate> {
