 ...
 */
@NotThreadSafe
public interface AsyncDocumentTreeNode<V> {
     ...
     */
    CompletableFuture<Iterator<AsyncDocumentTreeNode<V>>> children();
     ...
     */
    CompletableFuture<AsyncDocumentTreeNode<V>> child(String relativePath);

    /**
     * Returns if this node has one or more children.
     * @return {@code true} if yes, {@code false} otherwise
     */
    default CompletableFuture<Boolean> hasChildren() {
        return children().thenApply(Iterator::hasNext);
    }
}
