...
public class AtomixAtomicCounterMap extends AbstractRaftPrimitive implements AsyncAtomicCounterMap<String> {
    ...
    public AtomixAtomicCounterMap(PartitionProxy proxy) {
        super(proxy);
    }

    @Override
    public CompletableFuture<Long> incrementAndGet(String key) {
        return invoke(INCREMENT_AND_GET, SERIALIZER::encode, new IncrementAndGet(key), SERIALIZER::decode);
    }

    @Override
    public CompletableFuture<Long> decrementAndGet(String key) {
        return invoke(DECREMENT_AND_GET, SERIALIZER::encode, new DecrementAndGet(key), SERIALIZER::decode);
    }

    @Override
    public CompletableFuture<Long> getAndIncrement(String key) {
        return invoke(GET_AND_INCREMENT, SERIALIZER::encode, new GetAndIncrement(key), SERIALIZER::decode);
    }

    @Override
    public CompletableFuture<Long> getAndDecrement(String key) {
        return invoke(GET_AND_DECREMENT, SERIALIZER::encode, new GetAndDecrement(key), SERIALIZER::decode);
    }

    @Override
    public CompletableFuture<Long> addAndGet(String key, long delta) {
        return invoke(ADD_AND_GET, SERIALIZER::encode, new AddAndGet(key, delta), SERIALIZER::decode);
    }

    @Override
    public CompletableFuture<Long> getAndAdd(String key, long delta) {
        return invoke(GET_AND_ADD, SERIALIZER::encode, new GetAndAdd(key, delta), SERIALIZER::decode);
    }
    ...
    public CompletableFuture<Long> put(String key, long newValue) {
        return invoke(PUT, SERIALIZER::encode, new Put(key, newValue), SERIALIZER::decode);
    }

    @Override
    public CompletableFuture<Long> putIfAbsent(String key, long newValue) {
        return invoke(PUT_IF_ABSENT, SERIALIZER::encode, new PutIfAbsent(key, newValue), SERIALIZER::decode);
    }
    ...
    public CompletableFuture<Long> remove(String key) {
        return invoke(REMOVE, SERIALIZER::encode, new Remove(key), SERIALIZER::decode);
    }

    @Override
    public CompletableFuture<Boolean> remove(String key, long value) {
        return invoke(REMOVE_VALUE, SERIALIZER::encode, new RemoveValue(key, value), SERIALIZER::decode);
    }
