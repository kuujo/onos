...
public class AtomixAtomicIdGenerator implements AsyncAtomicIdGenerator {
    private final io.atomix.core.generator.AsyncAtomicIdGenerator atomixIdGenerator;

    public AtomixAtomicIdGenerator(io.atomix.core.generator.AsyncAtomicIdGenerator atomixIdGenerator) {
