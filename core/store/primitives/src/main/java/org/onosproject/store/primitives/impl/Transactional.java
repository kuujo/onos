...
public interface Transactional<T> {
     ...
     */
    CompletableFuture<LockVersion> begin(TransactionId transactionId);
     ...
     */
    CompletableFuture<Boolean> prepare(TransactionId transactionId, List<T> transactionLog);
     ...
     * {@code false} otherwise
     */
    CompletableFuture<Boolean> prepareAndCommit(TransactionId transactionId, List<T> transactionLog);
