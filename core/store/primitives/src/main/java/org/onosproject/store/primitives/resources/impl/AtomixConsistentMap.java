...
public class AtomixConsistentMap extends AbstractRaftPrimitive implements AsyncConsistentMap<String, byte[]> {
    ...
    public CompletableFuture<Versioned<byte[]>> put(String key, byte[] value) {
        return proxy.<UpdateAndGet, MapEntryUpdateResult<String, byte[]>>submit(
                UPDATE_AND_GET,
                SERIALIZER::encode,
    ...
    public CompletableFuture<Void> clear() {
        return proxy.<MapEntryUpdateResult.Status>submit(CLEAR, SERIALIZER::decode)
    ...
    public CompletableFuture<Version> begin(TransactionId transactionId) {
        return proxy.<TransactionBegin, Long>submit(
                BEGIN,
                SERIALIZER::encode,
    ...
    public CompletableFuture<Boolean> prepare(TransactionLog<MapUpdate<String, byte[]>> transactionLog) {
        return proxy.<TransactionPrepare, PrepareResult>submit(
                PREPARE,
                SERIALIZER::encode,
    ...
    public CompletableFuture<Boolean> prepareAndCommit(TransactionLog<MapUpdate<String, byte[]>> transactionLog) {
        return proxy.<TransactionPrepareAndCommit, PrepareResult>submit(
                PREPARE_AND_COMMIT,
                SERIALIZER::encode,
    ...
    public CompletableFuture<Void> commit(TransactionId transactionId) {
        return proxy.<TransactionCommit, CommitResult>submit(
                COMMIT,
                SERIALIZER::encode,
