...
public class PartitionedTransactionalMap<K, V> implements TransactionalMap<K, V> {
    private final Map<PartitionId, TransactionalMapPartition<K, V>> partitions;
    private final Hasher<K> hasher;

    public PartitionedTransactionalMap(Map<PartitionId, TransactionalMapPartition<K, V>> partitions, Hasher<K> hasher) {
