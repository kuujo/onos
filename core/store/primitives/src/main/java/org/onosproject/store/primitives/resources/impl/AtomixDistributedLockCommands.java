 ...
 * Lock commands.
 */
public final class AtomixDistributedLockCommands {

    private AtomixDistributedLockCommands() {
    }

    /**
     * Abstract lock command.
     */
    public abstract static class LockCommand<V> implements Command<V>, CatalystSerializable {
        @Override
    ...
    public static class TypeResolver implements SerializableTypeResolver {
        ...
        public void resolve(SerializerRegistry registry) {
            registry.register(Lock.class, -810);
            registry.register(Unlock.class, -811);
            registry.register(LockEvent.class, -812);
        }
    }
