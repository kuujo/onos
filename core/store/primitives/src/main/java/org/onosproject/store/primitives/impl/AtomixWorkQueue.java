...
public class AtomixWorkQueue<E> implements WorkQueue<E> {
    private final io.atomix.core.queue.AsyncWorkQueue<E> atomixWorkQueue;
    private final Map<SetEventListener<E>, io.atomix.core.set.SetEventListener<E>> listenerMap =
        Maps.newIdentityHashMap();

    public AtomixWorkQueue(io.atomix.core.queue.AsyncWorkQueue<E> atomixWorkQueue) {
