...
public class AtomixConsistentTreeMap<V> implements AsyncConsistentTreeMap<V> {
    private final io.atomix.core.map.AsyncConsistentTreeMap<V> atomixTreeMap;
    private final Map<MapEventListener<String, V>, io.atomix.core.map.MapEventListener<String, V>> listenerMap =
        Maps.newIdentityHashMap();

    public AtomixConsistentTreeMap(io.atomix.core.map.AsyncConsistentTreeMap<V> atomixTreeMap) {
    ...
    public synchronized CompletableFuture<Void> addListener(MapEventListener<String, V> listener, Executor executor) {
        io.atomix.core.map.MapEventListener<String, V> atomixListener = event ->
