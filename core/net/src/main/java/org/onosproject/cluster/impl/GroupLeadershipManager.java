...
public class GroupLeadershipManager
    extends AbstractListenerManager<GroupLeadershipEvent, GroupLeadershipEventListener>
    implements GroupLeadershipService, GroupLeadershipAdminService {

    private final Logger log = getLogger(getClass());

    private GroupLeadershipStoreDelegate delegate = this::post;
    ...
    public void activate() {
        ...
        eventDispatcher.addSink(GroupLeadershipEvent.class, listenerRegistry);
        log.info("Started");
    }
    ...
    public void deactivate() {
        ...
        eventDispatcher.removeSink(GroupLeadershipEvent.class);
        log.info("Stopped");
    }
